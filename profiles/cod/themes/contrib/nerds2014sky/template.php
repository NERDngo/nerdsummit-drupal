<?php
// nerds2014sky by Adaptivethemes.com

/**
 * Override or insert variables into the html template.
 */
function nerds2014sky_preprocess_html(&$vars) {
  global $theme_key;
 ...
 * Override or insert variables into the html template.
 */
function nerds2014sky_process_html(&$vars) {
 ...
 */
function nerds2014sky_preprocess_page(&$vars) {
 ...
 * Override or insert variables into the page template.
 */
function nerds2014sky_process_page(&$vars) {
  // Hook into the color module.
  if (module_exists('color')) {
 ...
 */
function nerds2014sky_preprocess_block(&$vars) {
 ...
 */
function nerds2014sky_preprocess_node(&$vars) {
 ...
 */
function nerds2014sky_preprocess_comment(&$vars) {
  // Add class if user picture exists
  if ($vars['picture']) {
 ...
 */
function nerds2014sky_process_region(&$vars) {
